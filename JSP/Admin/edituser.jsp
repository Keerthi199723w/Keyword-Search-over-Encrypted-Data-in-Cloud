...
<table id="login" align="center" width="300px"
	style="position: absolute; top: 20px; left: 200px;">
	<tr>
		<td colspan="2" align="center"><font
			style="font-family: cursive; font-size: 20px; color: black;"><b>Edit User Details</b></font></td>
	</tr>
	...
	<tr>
		...
		<td colspan="1"><input type="text" name="code" value="<%=ucode%>"
	...
	<tr>
		...
		<td colspan="1"><input type="text" name="unm" value="<%=name%>"
			required="yes"></td>
	...
	<tr>
		...
		<td colspan="1"><input type="text" name="ucity" value="<%=city%>"
			required="yes"></td>
	...
	<tr>
		...
		<td colspan="1"><input type="text" name="umobile"
			value="<%=mobile%>" required="yes"></td>
	...
	<tr>
		...
		<td colspan="4" align="center"><input type="submit" name="gname"
			value="Update"></td>
...
<div
	style="position: absolute; top: -10px; left: 50px; color: #8B4513; font-size: 20px;">
